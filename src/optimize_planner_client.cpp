...
int main(int argc, char **argv)
{
    ...
    //0.963370331992118, -1.0569796033832888, -1.98735200133103, -1.728010136339214, -0.9936858711813173, -0.7909874477768619, 1.9650294627394935

    float Jnt_Val_s = 0.963370331992118;
    float Jnt_Val_l = -1.0569796033832888;
    float Jnt_Val_e = -1.98735200133103;
    float Jnt_Val_u = -1.728010136339214;
    float Jnt_Val_r = -0.9936858711813173;
    float Jnt_Val_b =  -0.7909874477768619;
    float Jnt_Val_t =  1.9650294627394935;
